...
planepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  output += '</p><p>Construire une formule (ci-dessous) qui calcule le nombre total de si\u00E8ges dans l\u2019avion quand le nombre de rang\u00E9es est modifi\u00E9 (ci-dessus).</p><script src="../../lib/blockly/blockly_compressed.js"><\/script><script src="../../lib/blockly/blocks_compressed.js"><\/script><script src="../../lib/blockly/javascript_compressed.js"><\/script><script src="../../lib/blockly/msg/' + soy.$$escapeHtml(opt_ijData.lang) + '.js"><\/script><script src="blocks.js"><\/script>' + planepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div>';
  return output;
};
if (goog.DEBUG) {
